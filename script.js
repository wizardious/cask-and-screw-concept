...
const products = [
  {
    ...
    badge: "Alberta",
    type: "spirit",
    image: "images/alberta-premium.png",
    description:
      "A recognizable whisky selection from the supplied Cask and Screw inventory export."
  },
  {
    id: 2,
...

  {
    ...
    badge: "Alberta",
    type: "spirit",
    image: "images/alberta-pure.png",
    description:
      "A clean and versatile vodka selection from the supplied inventory export."
  },
  {
    id: 12,
    name: "Smirnoff Vodka",
  ...
  },
  {
    ...
    description:
      "A premium vodka selection from the supplied inventory export."
  },
  {
    id: 15,
    name: "Absolut Vodka",
    ...
    type: "spirit",
    description:
      "A vodka selection from the supplied inventory export."
  },
  {
    id: 16,
...

  {
    ...
    description:
      "A popular rum selection from the supplied inventory export."
  },
  {
    id: 18,
...

  {
    ...
    type: "spirit",
    description:
      "A tequila selection from the supplied inventory export."
  },
  {
    id: 24,
  ...
  },
  {
    ...
    type: "spirit",
    description:
      "A premium tequila selection from the supplied inventory export."
  },
  {
    id: 26,
...

  {
    ...
    type: "beer",
    description:
      "A familiar beer option from the supplied inventory export."
  },
  {
    id: 30,
    name: "Coors Light",
...

  {
    ...
    type: "rtd",
    description:
      "A ready-to-drink selection from the supplied inventory export."
  },
  {
    id: 40,
...

  {
    ...
    badge: "Featured",
    type: "wine",
    image: "images/apothic-red.png",
    description:
      "A wine selection from the supplied inventory export."
  },
  {
    id: 50,
...
function renderProducts() {
  ...
  productGrid.innerHTML = result
    .map(product => {
      const visual =
        categoryVisuals[product.category] ||
      ...
      return `
        <article class="product-card ${product.type}">
...
function openProduct(id) {
  ...
  if (modalMeta) {
    modalMeta.textContent = product.size;
  }
...
const priceDisclaimer = document.querySelector(
  ".price-disclaimer"
);

if (priceDisclaimer) {
  priceDisclaimer.innerHTML = `
    <strong>Portfolio project notice:</strong>
    This is a concept website and is not the official
    Cask and Screw Liquor website. Product information
    and prices were populated from a supplied inventory
    export and may not reflect current pricing or stock.
  `;
}
...
if (
  sessionStorage.getItem("caskAgeVerified") === "yes"
) {
  if (ageGate) {
    ageGate.classList.add("hidden");
  }
...
function updateStoreStatus() {
  const time = getAirdrieTime();
  const today = storeHours[time.day];
